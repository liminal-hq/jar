...
describe('CastleAvoidanceBehaviour', () => {
  it('produces zero force for a large fish centred in the doorway, despite overlapping wall margins', () => {
    ...
    const behaviour = new CastleAvoidanceBehaviour(bigFishMargin);
