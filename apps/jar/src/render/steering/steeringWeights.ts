...
export const MODE_WEIGHTS: Record<FishMotionMode, ModeWeights> = {
  active: { wander: 1, separation: 1, arrive: 0 },
  paused: { wander: 0, separation: 1, arrive: 0 },
  settling: { wander: 0, separation: 0, arrive: 1 },
  settled: { wander: 0, separation: 0, arrive: 0 },
};
